...
public class AmdJNI {
    ...
    public static class AmdResult {
        ...
        public String toString() {
            return String.format(
                    "AmdResult[classId=%d, conf=%.2f, rect=%s]", classId, conf, rect.toString());
        }
    ...
    public static native long create(
            String modelPath, int numClasses, int modelVer, int deviceMask);
     ...
     */
    public static native AmdResult[] detect(
            long ptr, long imgPtr, double nmsThresh, double boxThresh);
