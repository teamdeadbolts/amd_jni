...
class AmdJNITest {
    ...
    private static final String MODEL_PATH = System.getenv("AMD_MODEL_PATH") != null 
        ? System.getenv("AMD_MODEL_PATH") 
        : "models/yolov5s.onnx";
    
    private static final String TEST_IMAGE_PATH = System.getenv("AMD_TEST_IMAGE") != null
    ...
    void testDetectWithSyntheticImage() {
        ...
        try {
            AmdJNI.AmdResult[] results = AmdJNI.detect(
                detectorPtr, 
    ...
    private void saveAnnotatedImage(Mat image, AmdJNI.AmdResult[] results, String outputPath) {
        ...
        for (AmdJNI.AmdResult result : results) {
            ...
            org.opencv.imgproc.Imgproc.rectangle(
                ...
                new org.opencv.core.Point(result.rect.x + result.rect.width, 
            ...
            // Prepare label text
            String className = result.getClassId() < cocoClasses.length 
    ...
    void testDetectWithInvalidDetectorPointer() {
        ...
        try {
            Exception exception = assertThrows(Exception.class, () -> {
                AmdJNI.AmdResult[] results = AmdJNI.detect(-1, testImage.getNativeObjAddr(), NMS_THRESHOLD, BOX_THRESHOLD);
    ...
    void testDetectWithDifferentThresholds() {
        ...
        try {
            ...
            AmdJNI.AmdResult[] highThreshResults = AmdJNI.detect(
                detectorPtr, 
                image.getNativeObjAddr(), 
                0.45, 
            ...
            AmdJNI.AmdResult[] lowThreshResults = AmdJNI.detect(
                detectorPtr, 
                image.getNativeObjAddr(), 
                0.45, 
    ...
    void testDestroy() {
        ...
        try {
            Exception exception = assertThrows(Exception.class, () -> {
                AmdJNI.detect(detectorPtr, testImage.getNativeObjAddr(), NMS_THRESHOLD, BOX_THRESHOLD);
